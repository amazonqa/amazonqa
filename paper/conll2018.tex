...
\url{https://github.com/acl-org/acl-pub}, with modifications by Miikka
Silfverberg, based on the EMNLP 2018 instructions by Micha Elsner and
Preethi Raghavan, the NAACL 2018 instructions by Margaret
Michell and Stephanie Lukin, 2017/2018 (NA)ACL bibtex suggestions from
Jason Eisner, ACL 2017 by Dan Gildea and Min-Yen Kan, NAACL 2017 by
Margaret Mitchell, ACL 2012 by Maggie Li and Michael White, those from
ACL 2010 by Jing-Shing Chang and Philipp Koehn, those for ACL 2008 by
Johanna D. Moore, Simone Teufel, James Allan, and Sadaoki Furui, those
for ACL 2005 by Hwee Tou Ng and Kemal Oflazer, those for ACL 2002 by
Eugene Charniak and Dekang Lin, and earlier ACL and EACL formats.
Those versions were written by several people, including John Chen,
Henry S. Thompson and Donald Walker. Additional elements were taken
from the formatting instructions of the {\em International Joint
  Conference on Artificial Intelligence} and the \emph{Conference on
...
\conforg{} provides this description in \LaTeX2e{} ({\small\tt
  conll2018.tex}) and PDF format ({\small\tt conll2018.pdf}), along
with the \LaTeX2e{} style file used to format it ({\small\tt
  conll2018.sty}) and an ACL bibliography style ({\small\tt
  acl\_natbib\_nourl.bst}) and example bibliography ({\small\tt
  conll2018.bib}).  These files are all available at
\url{http://conll.org/downloads/conll18-latex.zip}; a Microsoft
Word template file ({\small\tt conll18-word.docx}) and example
submission pdf ({\small\tt conll18-word.pdf}) is available at
\url{http://conll.org/downloads/conll18-word.zip}.  We strongly
...
\verb|\bibliography{conll2018}|}

Where \verb|conll2018| corresponds to the {\tt conll2018.bib} file.
\bibliography{conll2018}
