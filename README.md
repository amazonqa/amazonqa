...
### Resume Training
    nohup python3 -u language_models/main.py --category Electronics --mode train --resume 1 --epoch 3 --model_name LM_QAR --hdim_a 512 --hdim_q 256 --hdim_r 256 --logfile Electronics-QAR.logfile --batch_size 10 > Electronics-QAR.out &
