...
class EncoderRNN(BaseRNN):
    ...
    def __init__(self, vocab_size, h_size, max_input_len, rnn_cell=C.RNN_CELL_LSTM, n_layers=1):
        super(EncoderRNN, self).__init__(vocab_size, h_size, max_input_len, rnn_cell, n_layers)
